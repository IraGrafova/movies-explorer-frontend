  ...
  return (
    <section className="about-me">
      ...
      <p className="about-me__description">
        ...
        факультет ИКСС в СПБГУТ. У меня есть муж и дочь. Я люблю делать вещи своими руками. Недавно начала кодить. С 2016 года
        работала в компании «Нии Масштаб». После того, как пройду курс по
        веб-разработке, хочу сменить работу и иметь возможность
        работать удаленно.
      </p>
